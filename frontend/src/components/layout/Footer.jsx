      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            {/* Bọc logo và chữ BKJOBS bằng Link để về trang chủ */}
            <Link to="/" className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-hero shadow-lg shadow-primary/20">
                <Briefcase className="h-6 w-6 text-white" />
              </div>
              <span className="text-xl font-black tracking-[0.18em] text-primary">BKJOBS</span>
            </Link>

            <p className="text-sm text-muted-foreground">
              Nền tảng kết nối việc làm hiện đại dành cho ứng viên và nhà tuyển dụng tại Việt Nam
            </p>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} BKJOBS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
