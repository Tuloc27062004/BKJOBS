...
const Login = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <div className="pointer-events-none absolute left-0 top-24 h-72 w-72 rounded-full bg-primary/15 blur-3xl animate-float" />
      <div className="pointer-events-none absolute right-0 bottom-8 h-80 w-80 rounded-full bg-secondary/60 blur-3xl animate-float-delayed" />
      <Card className="animate-fade-up relative z-10 w-full max-w-md border-white/40 bg-white/85 shadow-2xl backdrop-blur-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Chào mừng bạn trở lại với BKJOBS
          </CardDescription>
        </CardHeader>
        <CardContent>
