  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-hero pt-28 pb-16 text-white md:pt-32">
          <div className="absolute -left-10 top-10 h-56 w-56 rounded-full bg-white/10 blur-3xl animate-float" />
          <div className="absolute right-0 top-20 h-72 w-72 rounded-full bg-secondary/20 blur-3xl animate-float-delayed" />
          <div className="container mx-auto px-4 text-center">
            <h1 className="animate-fade-up mb-4 text-4xl font-bold">Về BKJOBS</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="grid gap-8 md:grid-cols-2 mb-16">
              <Card className="animate-fade-up border-white/60 bg-white/80 backdrop-blur-sm">
              ...
              <Card className="animate-fade-up animation-delay-150 border-white/60 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-8 text-center">
                  <div className="flex justify-center mb-4">
                    <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center">
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                BKJOBS là nền tảng tuyển dụng trực tuyến hàng đầu tại Việt Nam, kết nối hàng ngàn ứng viên với các cơ hội việc làm từ các doanh nghiệp uy tín.
              </p>
              <p className="text-muted-foreground mb-4">
