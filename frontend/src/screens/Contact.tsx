        ...
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden bg-gradient-hero pt-28 pb-16 text-white md:pt-32">
                    <div className="absolute -left-16 top-14 h-56 w-56 rounded-full bg-white/10 blur-3xl animate-float" />
                    <div className="absolute right-0 top-24 h-72 w-72 rounded-full bg-secondary/20 blur-3xl animate-float-delayed" />
                    <div className="container mx-auto px-4 text-center">
                        <h1 className="animate-fade-up mb-4 text-4xl font-bold">Liên hệ</h1>
                        <p className="mx-auto max-w-2xl text-lg opacity-90">
                            Danh sách email thành viên nhóm BKJOBS
                        </p>
                    </div>
                </section>
                ...
                <section className="py-16">
                    <div className="container mx-auto max-w-3xl px-4">
                        <Card className="animate-fade-up border-white/60 bg-white/80 shadow-xl backdrop-blur-sm">
