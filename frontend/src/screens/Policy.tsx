                ...
                <section className="bg-gradient-hero pt-28 md:pt-32 pb-16 text-white">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg opacity-90">
                            Vui lòng đọc kỹ trước khi sử dụng dịch vụ của BKJOBS
                        </p>
                    </div>
                </section>
                            ...
                            <CardContent className="space-y-8 p-6 md:p-8">
                                ...
                                <section className="space-y-3">
                                    ...
                                    <p>
                                        ...
                                        dụng website và các dịch vụ liên quan của <strong>BKJOBS</strong>.
                                ...
                                <section className="space-y-3">
                                    ...
                                    <ul className="list-disc space-y-2 pl-6">
                                        ...
                                        <li>Thông báo ngay cho BKJOBS nếu phát hiện truy cập trái phép.</li>
                                    </ul>
                                </section>
                                ...
                                {/* 5. Quyền của BKJOBS */}
                                <section className="space-y-3">
                                    <h2 className="text-xl font-semibold">5. Quyền của BKJOBS</h2>
                                    <ul className="list-disc space-y-2 pl-6">
                                ...
                                <section className="space-y-3">
                                    ...
                                    <ul className="list-disc space-y-2 pl-6">
                                        <li>
                                            ...
                                            BKJOBS quyền sử dụng phi độc quyền nhằm vận hành và cải thiện dịch vụ.
                                        </li>
                                        <li>
                                            Thương hiệu, giao diện, mã nguồn và tài sản trí tuệ của BKJOBS thuộc quyền
                                            sở hữu của BKJOBS và/hoặc các bên cấp phép.
                                        </li>
                                    </ul>
                                </section>
                                ...
                                <section className="space-y-3">
                                    ...
                                    <p>
                                        ...
                                        riêng tư của BKJOBS. Bằng việc sử dụng dịch vụ, bạn đồng ý với các
                                ...
                                <section className="space-y-3">
                                    ...
                                    <ul className="list-disc space-y-2 pl-6">
                                        <li>
                                            Dịch vụ được cung cấp “như hiện có”. BKJOBS không bảo đảm tuyệt đối
                                            về độ chính xác của mọi nội dung do người dùng đăng tải.
                                        </li>
                                        <li>
                                            Trong mọi trường hợp, trách nhiệm của BKJOBS (nếu có) sẽ được giới hạn
                                ...
                                <section className="space-y-3">
                                    ...
                                    <p>
                                        BKJOBS có thể cập nhật Điều khoản theo thời gian. Phiên bản mới sẽ có hiệu lực
